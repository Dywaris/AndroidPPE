 ...
 */
class Entreprise extends \Epsi\FirstBundle\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'id', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'nom', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'adresse', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'ville', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'codePostal', '' . "\0" . 'Epsi\\FirstBundle\\Entity\\Entreprise' . "\0" . 'numTel'];
        }
