...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' => 'get1Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service',
            '2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' => 'get2Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service',
        ...
        $this->privates = array(
            '1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' => true,
            '2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495']) ? $this->services['1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495'] : $this->get1Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495']) ? $this->services['2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495'] : $this->get2Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'epsi', 'password' => 'simpleduc', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/Epsi/FirstBundle/Entity'))), 'Epsi\\FirstBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('EpsiFirstBundle' => 'Epsi\\FirstBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ad3090f59271a303676b22b2240b90ecceb7442658cbe508a4c191401237dc7a');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Epsi/FirstBundle/Resources/views'), 'EpsiFirst');
    ...
    /**
     * Gets the '1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get1Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service()
    {
        return $this->services['1_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get2Ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495Service()
    {
        return $this->services['2_ab90c0ade79ae8bcb13e2530b70ab44ce67c0bf840beee8f05505d54d0175495'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder.inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8o+v5+Q5JE', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oBaa9jZZkO', 0, 'kS2-NI3mHGo1c5WkOb9lxg', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qRm7Ct1sUB', 0, 'kS2-NI3mHGo1c5WkOb9lxg', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RVrf4r5Amx', 0, 'kS2-NI3mHGo1c5WkOb9lxg', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ca4b6901e53f0.73498162');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'EpsiFirstBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Epsi/FirstBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EpsiFirstBundle' => 'Epsi\\FirstBundle\\EpsiFirstBundle',
